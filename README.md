# SQL Query Generator Platform

A modern, AI-powered SQL query generator application that allows users to ask questions and receive intelligent, context-aware responses. Built with FastAPI backend and React frontend.

![SQL Query Generator](https://img.shields.io/badge/FastAPI-005571?style=for-the-badge&logo=fastapi)
...
```bash
git clone https://github.com/Sujaanb/sql_query_generator.git
